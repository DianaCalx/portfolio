...
const resources = {
  en: {
    translation: {
      ...
      aboutMe:
        "Professional with 3 years of experience in computer networking, specializing in the management and optimization of technological infrastructures. And with 2 years of experience in frontend development. Currently focused on expanding my career into software development, leveraging my technical expertise to create efficient and innovative digital solutions.",
      engineer: "Computer Science Engineer",
      available: "Available to work",
      appleTitle: "Apple Website",
      appleDesc:
        "This project is built with modern technologies including React for the UI, Vite for fast development, GSAP for smooth animations, and Three.js for interactive 3D experiences.",
      ...
      productDesc:
        "This project is developed using React with TypeScript for a robust UI, Vite for fast builds, Express for the backend, and Sequelize for efficient database management.",
      caloriesTitle: "Calories Tracker Website",
      caloriesDesc:
        "This project is built with React for the UI, the Reducer Hook for state management, and TailwindCSS for responsive and modern styling.",
      skills: "Skills",
    },
  },
  es: {
    translation: {
      ...
      aboutMe:
        "Profesional con 3 años de experiencia en redes informáticas, especializada en la gestión y optimización de infraestructuras tecnológicas. Y con 2 años de experiencia en desarrollo frontend. Actualmente enfocada en expandir mi carrera hacia el desarrollo de software, aprovechando mi experiencia técnica para crear soluciones digitales eficientes e innovadoras.",
      engineer: "Ingeniera en Ciencias de la Computación",
      available: "Disponible para trabajar",
      appleTitle: "Sitio web de Apple",
      appleDesc:
        "Este proyecto está construido con tecnologías modernas que incluyen React para la interfaz de usuario, Vite para un desarrollo rápido, GSAP para animaciones suaves y Three.js para experiencias 3D interactivas.",
      ...
      productDesc:
        "Este proyecto está desarrollado utilizando React con TypeScript para una interfaz de usuario robusta, Vite para compilaciones rápidas, Express para el backend y Sequelize para una gestión eficiente de la base de datos.",
      caloriesTitle: "Sitio web Contador de Calorías",
      caloriesDesc:
        "Este proyecto está construido con React para la interfaz de usuario, usa Reducer Hook para la gestión del estado y TailwindCSS para estilos modernos y responsivos.",
      skills: "Habilidades",
    },
  },
};
